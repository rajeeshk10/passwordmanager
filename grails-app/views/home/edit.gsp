    ...
    <fieldset>
        ...
        <section>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <g:select name="account.accountType.id"  from="${AccountType.list()}"  class="form-control" value=""
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="account.tempUsername" type="text" placeholder="placeholder" value="account.tempUsername" class="form-control input-md typeahead">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4" >
                    <input name="account.tempPassword" id="password" type="text" placeholder="placeholder"  value="account.tempPassword" class="form-control input-md typeahead">
                </div>
            </div>
