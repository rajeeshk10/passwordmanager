create table account (id bigint not null auto_increment, version bigint not null, account_type_id bigint not null, username varchar(255) not null, password varchar(255) not null, primary key (id)) ENGINE=InnoDB;
...
create table user (id bigint not null auto_increment, version bigint not null, username varchar(255) not null, role varchar(255) not null, password varchar(255) not null, full_name varchar(255) not null, primary key (id)) ENGINE=InnoDB;
